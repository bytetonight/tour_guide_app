...
public class SportsPlace implements PointOfInterest, Parcelable {

    public static final Creator<SportsPlace> CREATOR =
            new Creator<SportsPlace>() {

                @Override
                public SportsPlace createFromParcel(Parcel source) {
                    return new SportsPlace(source);
                }

                @Override
                public SportsPlace[] newArray(int size) {
                    return new SportsPlace[size];
                }
            };
    ...
    public SportsPlace(Parcel parcel) {
    ...
    public SportsPlace(String name, String teaserText, String detailText, int previewImgResourceId) {
    ...
    public SportsPlace(String name, String teaserText, String address, String website,
