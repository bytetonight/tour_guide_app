...
public class HistoricalPlace implements PointOfInterest, Parcelable {

    public static final Creator<HistoricalPlace> CREATOR =
            new Creator<HistoricalPlace>() {

                @Override
                public HistoricalPlace createFromParcel(Parcel source) {
                    return new HistoricalPlace(source);
                }

                @Override
                public HistoricalPlace[] newArray(int size) {
                    return new HistoricalPlace[size];
                }
            };
    ...
    public HistoricalPlace(Parcel parcel) {
    ...
    public HistoricalPlace(String name, String teaserText, String detailText, int previewImgResourceId) {
    ...
    public HistoricalPlace(String name, String teaserText, String address, String website,
