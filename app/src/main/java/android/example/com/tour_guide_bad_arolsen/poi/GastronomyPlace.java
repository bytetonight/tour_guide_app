...
public class GastronomyPlace implements PointOfInterest, Parcelable {

    public static final Creator<GastronomyPlace> CREATOR =
            new Creator<GastronomyPlace>() {

                @Override
                public GastronomyPlace createFromParcel(Parcel source) {
                    return new GastronomyPlace(source);
                }

                @Override
                public GastronomyPlace[] newArray(int size) {
                    return new GastronomyPlace[size];
                }
            };
    ...
    public GastronomyPlace(Parcel parcel) {
    ...
    public GastronomyPlace(String name, String teaserText, String detailText, int previewImgResourceId) {
    ...
    public GastronomyPlace(String name, String teaserText, String address, String website,
